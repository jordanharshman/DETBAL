...
From this analysis, we can identify reaction loops. We will now only keep the data that has loops and remove all reversible reactions from the next step, resulting in the second matrix prior to row reduction:
...
rowred1.loop <- reactive({
  ...
  rowred1.noR <- rowred1.noR[, !names(rowred1.noR) %in% "Loop"]
